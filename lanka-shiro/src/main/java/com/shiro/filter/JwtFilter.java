...
import com.utils.JsonConvertUtil;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    private void response401(ServletRequest req, ServletResponse resp, String msg) {
        ...
        try {
            ...
            String data = JsonConvertUtil.objectToJson(ResultUtil.getInstance().setErrorMsg(ResultCode.NOT_LOGIN, msg));
            out.append(data);
        } catch (IOException e) {
